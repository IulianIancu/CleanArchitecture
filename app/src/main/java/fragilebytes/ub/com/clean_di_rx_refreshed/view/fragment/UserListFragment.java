 ...
 */
package fragilebytes.ub.com.clean_di_rx_refreshed.view.fragment;
...
import fragilebytes.ub.com.clean_di_rx_refreshed.presenter.UserListPresenter;
import fragilebytes.ub.com.clean_di_rx_refreshed.view.UserListView;
import fragilebytes.ub.com.clean_di_rx_refreshed.view.adapter.UsersAdapter;
import fragilebytes.ub.com.clean_di_rx_refreshed.view.adapter.UsersLayoutManager;
...
public class UserListFragment extends BaseFragment implements UserListView {
  ...
  public interface UserListListener {
    void onUserClicked(final Cake_model userModel);
  }
  ...
  @Override
  public void renderUserList(Collection<Cake_model> userModelCollection) {
  ...
  private UsersAdapter.OnItemClickListener onItemClickListener =
      new UsersAdapter.OnItemClickListener() {
        @Override
        public void onUserItemClicked(Cake_model userModel) {
